...
nexttile([4, 1])
hold on
fplot( left_basis, double( left_domain ), LineWidth=2, MeshDensity=23 * length( degree ) )
fplot( right_basis, double( right_domain ), LineWidth=2, MeshDensity=23 * length( degree ) )
