...
Specifically, we will utilize symbolic calculations, which will allow us to initially avoid the topic (and complexity) of quadrature and instead use symbolic integration and effortlessly compute derivatives (e.g., of basis functions) using symbolic operations.
...
1. Introducing Galerkin's Method via Scalar Projection
2. Adding Boundary Conditions to Galerkin's Method
3. Solving Partial Differential Equations with Galerkin's Method
4. Piecewise Polynomials in Galerkin's Method
5. Improving Performance through Improved Weak Formulations
6. Improving Performance through Quadrature
7. Improving Performance through Floating-Point Arithmetic