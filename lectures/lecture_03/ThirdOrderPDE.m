function [u, M, F, basis, d] = ThirdOrderPDE( basis_family, degree, domain, distributed_load, displacement_constraint, slope_constraint, gradient_constraint, boundary_tol, penalty )
